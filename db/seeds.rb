...
Customer.create(email: "test2@test2", last_name: "test2last", read_last_name: "テスト２姓", first_name: "test2name", read_first_name: "テスト２名", phone_number: "testphonenumber", post_code: "test_post_code", prefecture: "test_prefecture", city: "test-city", street: "test-street", password: "testtest")
Customer.create(email: "test3@test3", last_name: "test3last", read_last_name: "テスト３姓", first_name: "test3name", read_first_name: "テスト３名", phone_number: "testphonenumber", post_code: "test_post_code", prefecture: "test_prefecture", city: "test-city", street: "test-street", password: "testtest")
Customer.create(email: "test4@test4", last_name: "test4last", read_last_name: "テスト４姓", first_name: "test4name", read_first_name: "テスト４名", phone_number: "testphonenumber", post_code: "test_post_code", prefecture: "test_prefecture", city: "test-city", street: "test-street", password: "testtest")
